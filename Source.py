...
async def fox(ctx): # b'\xfc'
    ...
    em = discord.Embed(title="Reluctant Selfbot", description="Made By Major", color=0xff0000)
...
async def on_message(message):
    if autoafk is True:
        if isinstance(message.channel, discord.channel.DMChannel) and message.author != Reluctant.user:
            for i in range(1):
                embed = discord.Embed(title="Reluctant Selfbot", description="Made by Major", color=0xff0000)
                embed.set_image(url="https://cdn.discordapp.com/attachments/857072774026887171/872558823733350450/standard_2.gif")
...
async def showperms(ctx, user: discord.Member = None):
    await ctx.message.delete()
    embed = discord.Embed(title="Reluctant Selfbot", description="Made By Major", colour=0xff0000)
    embed.set_image(url="https://cdn.discordapp.com/attachments/857072774026887171/872558823733350450/standard_2.gif")
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Reluctant Selfbot By Major",
...
async def Reluctantslide( ctx):
    list = (
        ...
        "```m Selfbot by Major```",
        "```um Selfbot by Major```",
        "```ium Selfbot by Major```",
        "```dium Selfbot by Major```",
        "```Reluctant Selfbot by Major```",
        "``` Reluctant Selfbot by Major```",
        "```  Reluctant Selfbot by Major```",
        "```   Reluctant Selfbot by Major```",
        "```    Reluctant Selfbot by MajorRhin```",
        "```     Reluctant Selfbot by MajorRhi```",
        "```      Reluctant Selfbot by MajorRh```",
        "```       Reluctant Selfbot by MajorR```",
        "```        Reluctant Selfbot by Major```",
        "```         Reluctant Selfbot by Majo```",
        "```          Reluctant Selfbot by Maj```",
        "```           Reluctant Selfbot by Ma```",
        "```             Reluctant Selfbot by ```",
        "```              Reluctant Selfbot by```",
        "```               Reluctant Selfbot b```",
        "```                Reluctant Selfbot ```",
        "```                 Reluctant Selfbot```",
...
async def geoip(ctx, *, ip):  # b'\xfc'
    ...
    geo = r.json()
    em = discord.Embed(title="Reluctant Selfbot", description="Made by Major", color=0xff0000)
    em.set_image(url="https://cdn.discordapp.com/attachments/857072774026887171/872558823733350450/standard_2.gif")
